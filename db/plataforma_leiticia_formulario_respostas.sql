...
--
-- Table structure for table `formulario_respostas`
--
...
CREATE TABLE `formulario_respostas` (
  ...
  KEY `user_id` (`user_id`),
  CONSTRAINT `formulario_respostas_ibfk_1` FOREIGN KEY (`formulario_id`) REFERENCES `formularios` (`id`),
  CONSTRAINT `formulario_respostas_ibfk_2` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `formulario_respostas`
--

LOCK TABLES `formulario_respostas` WRITE;
/*!40000 ALTER TABLE `formulario_respostas` DISABLE KEYS */;
/*!40000 ALTER TABLE `formulario_respostas` ENABLE KEYS */;
UNLOCK TABLES;
