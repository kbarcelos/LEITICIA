...
CREATE TABLE `doacoes` (
  ...
  `status` enum('pendente','agendada','coletada','cancelada','finalizada') NOT NULL DEFAULT 'pendente',
  `volume_estimado` decimal(8,2) DEFAULT NULL,
  `data_agendamento` datetime DEFAULT NULL,
  `endereco_coleta` varchar(255) DEFAULT NULL,
  `observacoes` text,
  ...
  CONSTRAINT `doacoes_ibfk_1` FOREIGN KEY (`doadora_id`) REFERENCES `users` (`id`),
  CONSTRAINT `doacoes_ibfk_2` FOREIGN KEY (`banco_leite_id`) REFERENCES `bancos_leite` (`id`)
